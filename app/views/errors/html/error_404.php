...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- Core -->
    <link href="<?php echo strip_tags($base_url); ?>assets/css/core.css" rel="stylesheet">
    <script src="<?php echo strip_tags($base_url); ?>assets/js/vendors/jquery-3.2.1.min.js"></script>
    <style>
    	body{
		  background: #fff;
		}
	...
	<section class="page-404 text-center">
		<div class="container">
			<div class="row justify-content-md-center">
				<div class="col-md-5">
					<div class="box-image">
						<a href="<?php echo strip_tags($base_url); ?>"><img src="<?php echo strip_tags($base_url); ?>assets/images/no_result.gif" alt="404 error page"></a>
					</div>
					<div class="content">
						<div class="title">
						...
						<div class="go-back">
			              <a href="<?php echo strip_tags($base_url); ?>" class="btn btn-pill btn-gradient btn-go-home btn-min-width mr-1 mb-1"><span><i class="fe fe-arrow-left"></i></span> Back to Home Page</a>
			            </div>
					</div>
				</div>
			</div>
