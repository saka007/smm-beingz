...
class MY_Model extends CI_Model
{
	...
	function send_mail_template($template = [], $user_id_or_email, $from_email_data = []){
        ...
        if (isset($from_email_data['from_email']) && $from_email_data['from_email'] != "") {
            ...
            $from_email = get_option('email_from', '') ? get_option('email_from', '') : "do-not-reply@boostinstagramfollowers.com";
        }
        ...
        if (isset($from_email_data['from_mobile']) && $from_email_data['from_mobile'] != "") {
            $from_mobile = $from_email_data['from_mobile'];
        }
